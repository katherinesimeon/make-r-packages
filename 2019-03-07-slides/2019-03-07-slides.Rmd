...
2. Packages `devtools` and `roxygen2` (we'll use `usethis` too)   
]
...
install.packages(“devtools”) # you definitely need these packages
install.packages(“roxygen2”)

install.packages("usethis") # you could also use this 
...
* Unit testing (making sure each of your functions work)  
* Including datasets in your package  
...
This will create a `test` folder with an R script for your unit test.    
...
Data is stored in an `.RDa` file stored in a `data` folder.  
...
Add a `data.R` file that has documentation of **all** datasets in a package with roxygen comments.   
   
  
See a good example of this documentation in [ggplot2](https://github.com/tidyverse/ggplot2/blob/master/R/data.R).  
  
  
--
  
*This should not be done with large data sets!*
